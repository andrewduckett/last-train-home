	...
	venues: [
		{
			stop: 'Stop 1',
			town: 'Mt. Prospect',
			places: [{ n: 'Station 34', a: '34 S Main St' }],
		},
		{
			stop: 'Stop 2',
			town: 'Edison Park',
			places: [{ n: 'Edison Park Inn', a: '6715 N Olmsted Ave' }],
		},
		{
			stop: 'Stop 3',
			town: 'Arlington Heights',
			places: [{ n: "Eddie's", a: '10 E Northwest Hwy' }],
		},
		{
			stop: 'Stop 4',
			town: 'Palatine',
			places: [{ n: 'Tap House Grill', a: '56 W Wilson St' }],
		},
	],
