...
- An author can edit or add a valid crawl without touching a test. An invalid crawl still fails the build and the contract test, with a message that names the file.
