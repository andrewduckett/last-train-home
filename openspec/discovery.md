...
3. **Find the stop** — the Places tab lists each stop's locations with directions — done (`PlacesView`; directions open Apple Maps on Apple devices and Google Maps elsewhere, with no hardcoded state, shipped in [#25](https://github.com/andrewduckett/last-train-home/issues/25); stations and other authored locations, each with its own Directions link, shipped in [#27](https://github.com/andrewduckett/last-train-home/issues/27); the hard-to-use embedded map is gone, and the route map is an Info link, shipped in [#26](https://github.com/andrewduckett/last-train-home/issues/26))
